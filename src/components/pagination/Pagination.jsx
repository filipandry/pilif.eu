...
class Pagination extends Component {
  ...
  render() {
    ...
    var items = Array(max - min + 1)
      .fill()
      .map((i, index) => (
        <Button
          key={index}
          label={index + min}
          color={index + min === page ? "primary" : "default"}
          inline
          minWidth={50}
          spacing={2}
          onClick={this.onPageClick(index + min)}
        />
      ));
    ...
    return (
      <div className={classes.root}>
        ...
        <Button
          ...
          minWidth={50}
          spacing={2}
          onClick={this.onPageClick(page - 1)}
        />
        {before}
        {items}
        {after}
        ...
        <Button
          ...
          minWidth={50}
          spacing={2}
          onClick={this.onPageClick(count)}
        />
      </div>
    );
  }
